...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="data/model/saved_model2.lstmcrf.")
    parser.add_argument('--savedset', help='Dir of saved data setting', default="ResumeNER/save.dset")
